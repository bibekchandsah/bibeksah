...
const wrapperr = document.querySelector(".wrappper"),
toast = wrapperr.querySelector(".toastt"),
title = toast.querySelector("span"),
subTitle = toast.querySelector("p"),
wifiIcon = toast.querySelector(".iconn"),
closeIcon = toast.querySelector(".close-iconn");
...
function offline() { //function for offline
  wrapperr.classList.remove("hide");
